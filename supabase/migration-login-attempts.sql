...
-- Only service_role (Edge Functions) can access login_attempts
...
-- Function: check if an email is banned (>= 3 failed attempts in last 15 min)
...
-- Function: clear old attempts for an email (called on successful login)
